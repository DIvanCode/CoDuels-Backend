...
public sealed class CreateDuelConfigurationRequestValidator : AbstractValidator<CreateDuelConfigurationRequest>
{
    public CreateDuelConfigurationRequestValidator()
    {
