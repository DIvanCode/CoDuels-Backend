...
public class GetActiveDuelHandlerTests : ContextBasedTest
{
    [Fact]
    public async Task NotFound_when_no_active_duel()
    {
        var ctx = Context;
        ...
        var handler = new GetActiveDuelHandler(ctx, ratingManager.Object, new TaskService());

        var res = await handler.Handle(new GetActiveDuelQuery
        {
            UserId = 1
    ...
    [Fact]
    public async Task Returns_active_duel_for_user1()
    {
        var ctx = Context;
    ...
    [Fact]
    public async Task Returns_active_duel_for_user2()
    {
        var ctx = Context;
