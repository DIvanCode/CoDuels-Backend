...
namespace Duely.Infrastructure.DataAccess.EntityFramework.Migrations
{
    ...
    [Migration("20260703170525_CreateSubmissions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Duely.Domain.Models.Duels.Entities.Duel", b =>
                {
                    ...
                    b.Property<TimeSpan>("ConfirmTimeout")
            ...
            modelBuilder.Entity("Duely.Domain.Models.Duels.Entities.DuelConfiguration", b =>
                {
                    ...
                    b.Property<bool>("ShowOpponentSolution")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Duely.Domain.Models.Duels.Entities.Submission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DuelId", "ProblemId");

                    b.HasIndex("DuelId", "UserId", "ProblemId");

                    b.HasIndex("UserId", "DuelId", "ProblemId");
            ...
            modelBuilder.Entity("Duely.Infrastructure.IntegrationEvents.Models.ProcessSubmissionIntegrationEvent", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ProcessSubmission");
                });
            ...
            modelBuilder.Entity("Duely.Domain.Models.Duels.Entities.Submission", b =>
                {
                    ...
                    b.HasOne("Duely.Domain.Models.Duels.Entities.DuelProblem", "Problem")
                        .WithMany()
                        .HasForeignKey("DuelId", "ProblemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Duely.Infrastructure.IntegrationEvents.Models.ProcessSubmissionIntegrationEvent", b =>
                {
                    b.HasOne("Duely.Domain.Models.Duels.Entities.Submission", null)
                        .WithMany()
