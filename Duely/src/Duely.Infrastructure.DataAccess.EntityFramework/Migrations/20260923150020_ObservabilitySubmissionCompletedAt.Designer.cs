...
namespace Duely.Infrastructure.DataAccess.EntityFramework.Migrations
{
    ...
    [Migration("20260923150020_ObservabilitySubmissionCompletedAt")]
    partial class ObservabilitySubmissionCompletedAt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Duely.Domain.Models.Submission", b =>
                {
                    ...
                    b.HasIndex("Status", "SubmitTime");

                    b.HasIndex("Verdict", "CompletedAt");
            ...
            modelBuilder.Entity("Duely.Domain.Models.Groups.GroupMembership", b =>
                {
                    ...
                    b.HasOne("Duely.Domain.Models.User", "InvitedBy")
                        .WithMany()
