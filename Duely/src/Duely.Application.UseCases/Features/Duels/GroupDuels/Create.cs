...
//                 .Where(m => m.User.Id == user.Id || command.Participants.Contains(m.User.Id)))
...
//             {
//                 return new ForbiddenError("Участники дуэли должны быть в группе.");
//             }
//         }
//         
...
//                 .AsNoTracking()
//                 .Where(c => c.Id == duelConfigurationId)
//                 .SingleOrDefaultAsync(cancellationToken);
