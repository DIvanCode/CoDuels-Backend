...
type (
	...
	JobSchedulerConfig struct {
		...
		MetricsRetention          time.Duration `yaml:"metrics_retention" env:"METRICS_RETENTION"`
		MetricsMaxFinishedJobs    int           `yaml:"metrics_max_finished_jobs" env:"METRICS_MAX_FINISHED_JOBS"`
	}
